    ...
    return (
        <div className="about section__margin" id="about">
            ...
            <div className="about-container">
                <Feature title="skills and tools" text="C, C++, JavaScript, TypeScript, React, NextJS, Java, Python, Verilog, SystemVerilog, ModelSim, Assembly, Travis-CI, Git, Linux, Jira, Agile" />
                ...
                <Feature title="interests" text="In my free time, I love powerlifting, playing spikeball and soccer, thinking of fashionable new outfits, and solving geography quizes." />
            </div>
        </div>
    )
}
