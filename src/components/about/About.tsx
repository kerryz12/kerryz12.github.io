    ...
    return (
        <div className="about section__margin" id="about">
            ...
            <div className="about-container">
                ...
                <Feature title="interests" text="In my free time, I love powerlifting, creating music, playing spikeball and soccer with my friends, trying to come up with fashionable new outfits, and solving geography quizes." />
            </div>
        </div>
    )
}
