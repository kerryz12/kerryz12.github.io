    ...
    return (
        <div className="about section__margin" id="about">
            ...
            <div className="about-container">
                <Feature title="skills and tools" text="C, C++, JavaScript, TypeScript, React, NextJS, Vue, Java, Python, Verilog, SystemVerilog, ModelSim, Assembly, MATLAB, Travis-CI, Git, Linux, Jira, Agile, Pytorch, Numpy" />
